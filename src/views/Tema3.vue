  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 3
      h1 Factores y variables que impulsan las empresas
      ...
      .col-12.col-md-8.col-lg-9
        .bloque-texto-d.color-primario.p-4(data-aos="fade-down")
          .bloque-texto-d__texto.mb-2
            i.fas.fa-quote-left
            p.mb-0 La operación empresarial se produce en un contexto de múltiples variables y aspectos que la afectan permanentemente; en los años recientes se ha complejizado por su alta dinámica, pluralidad de variables, nuevos escenarios y actores, a efectos de la ruptura por la globalización e internacionalización para la actuación empresarial. En este sentido, las empresas están llamadas a desarrollar capacidades competitivas mucho más exigentes y versátiles que les permitan la sobrevivencia; para ser reconocidas y estar a la vanguardia, deberán hacer mayores esfuerzos para desarrollar una ventaja competitiva creciente y sostenida, en la que se demanda la identificación de estos factores y variables que la impactan positiva o negativamente; además se pretende evaluar o anticipar las nuevas alternativas técnicas, operativas y administrativas que faciliten, desde el presente, el futuro empresarial.
          .bloque-texto-d__autor 
            .h6.mb-0 - Rodríguez, 2012
        ...
        .tarjeta-a.color-primario.p-3
          .row.justify-content-around.align-items-center
            .col-3.col-sm-2.col-lg-2
              img(src="@/assets/curso/temas/cliente.svg")
            .col
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-12.col-md-6(data-aos="fade-down")
        figure
          img(src='@/assets/curso/temas/tema3/tema3-03.png', alt='')
      .col-12.col-md-6(data-aos="fade-down")
        .bloque-texto-c.color-primario.p-4
          i.fas.fa-quote-right
          p.mb-2 Las múltiples variables se agrupan según su naturaleza en factores, determinando un escenario de macroentorno y microentorno, que permite identificar los cambios del escenario empresarial, sectorial o industria para reconocer posibles oportunidades de crecimiento o amenazas.
          span - Laurence, 2014

    p.mb-4(data-aos="flip-down") Entonces:

    ul.lista-ul.mb-4
      li(data-aos="fade-down")
        i.fas.fa-atom(style="color: #304C8E")
        | El macroentorno es la parte del entorno de la empresa más lejana, con variables que afectan de manera general a todas las empresas de un país o región, del mismo sector económico en que pueden estar operando; por ejemplo: legislaciones, aspectos tecnológicos, económicos, etc. 
      li(data-aos="fade-down")
        i.fas.fa-atom(style="color: #304C8E")
        | El microentorno es la externalidad próxima a la empresa como, por ejemplo, los proveedores, clientes y la competencia.

    p.mb-4(data-aos="flip-down") Revisemos cuáles son estos factores externos:
 
    h3.text-center.mb-5 Factores y variables externos

    .row.align-items-stretch.justify-content-center.mb-5(data-aos="fade-down")
      .col-lg-6
        .tarjeta-avatar-b.mb-5(style="height:85%")
          .tarjeta-avatar-b__img
            img(src='@/assets/curso/temas/tema3/tema3-04.svg' alt='AvatarTop')
          .tarjeta.color-primario
            .p-4
              h4 Políticos y gubernamentales
              p.mb-0 Legislación tributaria, comercial, laboral, etc., las políticas fiscales, el riesgo país, la estabilidad normativa.
      .col-lg-6
        .tarjeta-avatar-b.mb-5(style="height:85%")
          .tarjeta-avatar-b__img
            img(src='@/assets/curso/temas/tema3/tema3-05.svg' alt='AvatarTop')
          .tarjeta.color-primario
            .p-4
              h4 Económicos
              p.mb-0 La recesión o reactivación económica, inflación, la tasa de cambio, el porcentaje de desempleo, las tasas de interés, el ingreso per cápita, y demás variable que considere la empresa con que esté relacionada.
      .col-lg-6
        .tarjeta-avatar-b.mb-5(style="height:85%")
          .tarjeta-avatar-b__img
            img(src='@/assets/curso/temas/tema3/tema3-06.svg' alt='AvatarTop')
          .tarjeta.color-primario
            .p-4
              h4 Sociales y Demográficos
              p.mb-0 Composición social por edades, por género, por ubicación rural o urbana, tasa de natalidad, tasa de mortalidad, esperanza de vida, nivel educativo, estratos socioeconómicos, hábitos sociales y culturales, religión, etnias, etc.
      .col-lg-6
        .tarjeta-avatar-b.mb-5(style="height:85%")
          .tarjeta-avatar-b__img
            img(src='@/assets/curso/temas/tema3/tema3-07.svg' alt='AvatarTop')
          .tarjeta.color-primario
            .p-4
              h4 Tecnológicos
      ...
      .col-lg-6
        .tarjeta-avatar-b.mb-5(style="height:85%")
          .tarjeta-avatar-b__img
            img(src='@/assets/curso/temas/tema3/tema3-08.svg' alt='AvatarTop')
          .tarjeta.color-primario
            .p-4
              h4 Clientes
              p.mb-0 En este factor se evalúa como se concentran, si están agremiados, como son las tendencias de consumo, si existe tasa de rotación de los clientes, el poder de negociación que tienen según su clasificación.
      .col-lg-6
        .tarjeta-avatar-b.mb-5(style="height:85%")
          .tarjeta-avatar-b__img
            img(src='@/assets/curso/temas/tema3/tema3-09.svg' alt='AvatarTop')
          .tarjeta.color-primario
            .p-4
              h4 Proveedores
      ...
      .col-lg-6
        .tarjeta-avatar-b.mb-5(style="height:85%")
          .tarjeta-avatar-b__img
            img(src='@/assets/curso/temas/tema3/tema3-10.svg' alt='AvatarTop')
          .tarjeta.color-primario
            .p-4
              h4 Competencia
